      ...
      <div className="sidebar">
        ...
        fontStyle: "normal"
          ...
          <ul className="nav nav-pills flex-column mb-auto">
            <li>
              <NavLink to="/employee-dashboard" end className="sidebar-link ">
                <i className="bi bi-speedometer2"></i>
                <span>Dashboard</span>
              </NavLink>
            </li>
            <li>
              <NavLink to={`/employee-dashboard/profile/${user._id}`}className="sidebar-link">
                <i className="bi bi-person-circle"></i>
                <span>My Profile</span>
              </NavLink>
            </li>
            <li>
              <NavLink to={`/employee-dashboard/leaves/${user._id}`} className="sidebar-link">
                <i className="bi bi-calendar-check"></i>
                <span>Leaves</span>
              </NavLink>
            </li>
            <li>
              <NavLink to={`/employee-dashboard/salary/${user._id}`}className="sidebar-link">
                <i className="bi bi-cash-stack"></i>
                <span>Salary</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/employee-dashboard/setting" className="sidebar-link">
